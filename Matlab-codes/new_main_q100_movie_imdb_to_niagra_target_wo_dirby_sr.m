...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/new_top2000_q100_movie_imdb_to_niagara_target_wo_dirby_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/cast.txt'], [DAT_LOC '/director.txt'] };
edge_files = { [DAT_LOC '/actor_cast.txt'], [DAT_LOC '/movie_cast.txt'], [DAT_LOC '/movie_director.txt']};
