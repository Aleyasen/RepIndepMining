...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/top2000_niagara_source';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/top2000_q100_movie_freebase_to_niagara_source_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/starring.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt']  };
edge_files = { [DAT_LOC '/starring_actor.txt'], [DAT_LOC '/starring_movie.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt'] };
