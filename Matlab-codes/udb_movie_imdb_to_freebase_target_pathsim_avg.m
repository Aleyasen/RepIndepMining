...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/udb_results/movie_imdb_to_freebase_target_result';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/film.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/starring.txt'], [DAT_LOC '/directedby.txt'], [DAT_LOC '/director.txt']};
edge_files = { [DAT_LOC '/actor_starring.txt'], [DAT_LOC '/character_starring.txt'], [DAT_LOC '/film_starring.txt'], [DAT_LOC '/director_directedby.txt'] , [DAT_LOC '/film_directedby.txt']};
...
label = 'film';
alg = 'pathsim'; 
metapath = {{'film','starring','actor'},{'film','starring','character'},{'film','directedby','director'}}; star = {[0 0 0],[0 0 0],[0 0 0]}; % star = 1 when label at i is star
