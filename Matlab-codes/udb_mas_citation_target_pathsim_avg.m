...
%% inputs
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/udb_citation';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/udb_results/mas_citation_target';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/paper.txt'],[DAT_LOC '/citation.txt']};
edge_files = { [DAT_LOC '/paper_citation.txt']};
...
label = 'paper';
alg = 'pathsim'; 
metapath = {{'paper','citation','paper'}}; star = {[0 0 0]}; % star = 1 when label at i is star
