...
%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/cast.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/writer.txt'], [DAT_LOC '/writedby.txt']  };
edge_files = { [DAT_LOC '/actor_cast.txt'], [DAT_LOC '/movie_cast.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt'], [DAT_LOC '/actor_character.txt'], [DAT_LOC '/character_cast.txt'], [DAT_LOC '/writedby_writer.txt'], [DAT_LOC '/writedby_movie.txt']};
