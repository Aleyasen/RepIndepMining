...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/mas-sample-yods';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/paper.txt'], [DAT_LOC '/conf.txt'] };
edge_files = { [DAT_LOC '/paper_paper.txt'], [DAT_LOC '/paper_conf.txt'] };
query_file = [DAT_LOC '/_query.txt'];
answer_loc = ANS_LOC;

label = 'conf';
alg = 'modpathsim1'; metapath = {'conf','paper','paper'}; star = [0 0 0]; % star = 1 when label at i is star
%alg = 'rwr';
%alg = 'simrank';
%alg = '?';
VERBOSE = 0;
