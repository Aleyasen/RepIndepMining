...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/simtest-imdb/fb-top5000';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/starring.txt'] };
edge_files = { [DAT_LOC '/starring_actor.txt'], [DAT_LOC '/starring_movie.txt'], [DAT_LOC '/starring_character.txt'] };
...
%% algorithms
alg = 'pathsim'; metapath = {'actor','starring','movie'};
