...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_source_path2_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/course.txt'], [DAT_LOC '/offer.txt'], [DAT_LOC '/inst.txt'], [DAT_LOC '/subject.txt']  };
edge_files = { [DAT_LOC '/offer_inst.txt'], [DAT_LOC '/course_offer.txt'], [DAT_LOC '/offer_subject.txt']};
query_file = [DAT_LOC '/_query_subject.txt'];
answer_loc = ANS_LOC;
label = 'subject';
alg = 'pathsim'; metapath = {'subject','offer','course'};
%alg = 'rwr';
%alg = 'simrank';
VERBOSE = 0;
