...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_target_path4_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/course.txt'], [DAT_LOC '/offer.txt'], [DAT_LOC '/inst.txt'], [DAT_LOC '/subject.txt']  };
edge_files = { [DAT_LOC '/course_inst.txt'], [DAT_LOC '/course_offer.txt'], [DAT_LOC '/course_subject.txt']};
query_file = [DAT_LOC '/_query_inst.txt'];
answer_loc = ANS_LOC;
label = 'inst';
alg = 'pathsim'; metapath = {'inst','course','offer'};
%alg = 'rwr';
%alg = 'simrank';
VERBOSE = 0;
