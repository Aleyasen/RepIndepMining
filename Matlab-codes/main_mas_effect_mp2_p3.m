...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/mas-effect-p3';
mkdir(ANS_LOC);
...
label = 'conf';
alg = 'modpathsim2'; metapath = {'conf','paper','domain'}; star = [0 1 0]; % star = 1 when label at i is star
%alg = 'rwr';
%alg = 'simrank';
%alg = '?';
VERBOSE = 0;
