...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/dblp_citation_temp';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-dblp_citation/source_result_temp_alaki';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/paper.txt']};
edge_files = { [DAT_LOC '/paper_paper.txt']};
