...
%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/starring.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt'], [DAT_LOC '/character.txt'] };
edge_files = { [DAT_LOC '/starring_actor.txt'], [DAT_LOC '/starring_movie.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt'], [DAT_LOC '/starring_character.txt'] };
