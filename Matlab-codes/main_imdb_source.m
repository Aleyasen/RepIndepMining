...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/top2000_imdb_source';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/top2000_imdb_target_result';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/character.txt']};
edge_files = { [DAT_LOC '/actor_character.txt'], [DAT_LOC '/movie_character.txt'], [DAT_LOC '/movie_actor.txt']};
