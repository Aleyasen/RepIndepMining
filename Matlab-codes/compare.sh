...
for((i=1; i<=${qcount}; i++))
do
	java -jar ./sim_kendall.jar ${folder1}/${alg}/answer.query${i}.txt ${folder2}/${alg}/answer.query${i}.txt 20
done
...
for((i=1; i<=${qcount}; i++))
do
	java -jar ./sim_kendall.jar ${folder1}/${alg}/answer.query${i}.txt ${folder2}/${alg}/answer.query${i}.txt 3
done