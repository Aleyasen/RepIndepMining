...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/mas-ave';
mkdir(ANS_LOC);
...
label = 'conf';
alg = 'pathsim'; 
metapath = {{'conf','paper','paper'}, {'conf','paper'}}; star = {[0 0 0], [0 0]}; % star = 1 when label at i is star
