...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/mas-effect-p4';
mkdir(ANS_LOC);
...
label = 'conf';
alg = 'modpathsim2'; metapath = {'conf','paper','domain', 'keyword'}; star = [0 0 0 0]; % star = 1 when label at i is star
%alg = 'rwr';
%alg = 'simrank';
%alg = '?';
VERBOSE = 0;
