...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/new_top2000_q100_movie_imdb_to_niagara_2_target_without_cast_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt'], [DAT_LOC '/character.txt']  };
edge_files = { [DAT_LOC '/movie_actor.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt'], [DAT_LOC '/actor_character.txt'], [DAT_LOC '/movie_character.txt']};
