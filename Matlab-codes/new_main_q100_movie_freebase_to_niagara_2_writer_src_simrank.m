...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/new_top2000_q100_movie_freebase_to_niagara_2_source_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/starring.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/writer.txt'], [DAT_LOC '/writedby.txt'] };
edge_files = { [DAT_LOC '/starring_actor.txt'], [DAT_LOC '/starring_movie.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt'], [DAT_LOC '/starring_character.txt'], [DAT_LOC '/writedby_writer.txt'], [DAT_LOC '/writedby_movie.txt'] };
