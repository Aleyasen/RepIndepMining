...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/top2000_imdb_target';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/top2000_imdb_source_result';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/starring.txt']};
edge_files = { [DAT_LOC '/starring_actor.txt'], [DAT_LOC '/starring_character.txt'], [DAT_LOC '/starring_movie.txt']};
