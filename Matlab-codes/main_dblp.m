...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/simtest-dblp/orig-c50-top2000';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/title.txt'], [DAT_LOC '/author.txt'], [DAT_LOC '/year.txt'], [DAT_LOC '/conf.txt'] };
edge_files = { [DAT_LOC '/title_author.txt'], [DAT_LOC '/title_conf.txt'], [DAT_LOC '/title_year.txt'] };
