...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/dblp-target-c50-pathsim-year-metapath';
mkdir(ANS_LOC);
...
query_file = [DAT_LOC '/_query_proc.txt'];
answer_loc = ANS_LOC;
label = 'proc';
...
%% algorithms
alg = 'pathsim'; metapath = {'proc','year'};
