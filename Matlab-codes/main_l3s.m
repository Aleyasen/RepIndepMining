...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/dblp/data/output_y2005_conf50_schema1_top2000';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/simtest-dblp/l3s-c50-top2000';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/title.txt'], [DAT_LOC '/author.txt'], [DAT_LOC '/year.txt'], [DAT_LOC '/conf.txt'], [DAT_LOC '/proc.txt'] };
edge_files = { [DAT_LOC '/title_author.txt'], [DAT_LOC '/title_conf.txt'], [DAT_LOC '/title_year.txt'], [DAT_LOC '/title_proc.txt'], [DAT_LOC '/proc_conf.txt'], [DAT_LOC '/proc_year.txt'] };
query_file = [DAT_LOC '/_query.txt'];
answer_loc = ANS_LOC;
label = 'author';
%alg = 'pathsim'; metapath = {'author','title','proc','conf'};
%alg = 'rwr';
alg = 'simrank';
VERBOSE = 0;
