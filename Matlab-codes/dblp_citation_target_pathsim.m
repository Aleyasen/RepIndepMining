...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/dblp_citation';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-dblp_citation/target_result';
mkdir(ANS_LOC);
...
answer_loc = ANS_LOC;
label = 'paper';
alg = 'pathsim'; metapath = {'paper','citation','paper'};
%alg = 'rwr';
%alg = 'simrank';
VERBOSE = 0;
