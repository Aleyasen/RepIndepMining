...
%DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/dblp/data/aale_dblp_y2005_conf100_schema1_top2000';
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/dblp/data/output_y2005_conf100_new_schema1_top2000';
%ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/dblp-target-c100-pathsim-top-authors-conf100-4fto8f';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/dblp-target-c100-top-authors-conf100-new';

mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/title.txt'], [DAT_LOC '/author.txt'], [DAT_LOC '/year.txt'], [DAT_LOC '/proc.txt'] };
edge_files = { [DAT_LOC '/title_author.txt'], [DAT_LOC '/title_proc.txt'], [DAT_LOC '/proc_year.txt'] };
query_file = [DAT_LOC '/_top_query.txt'];
answer_loc = ANS_LOC;
label = 'author';
%alg = 'pathsim'; metapath = {'author','title','proc'};
%alg = 'rwr';
%alg = 'simrank';
VERBOSE = 0;
...
%% algorithms
alg = 'pathsim'; metapath = {'author','title','proc','year'};
