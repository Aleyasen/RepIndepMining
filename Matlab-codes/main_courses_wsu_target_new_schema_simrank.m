...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/output-wsu1';

ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_target_wsu_schema_results';
mkdir(ANS_LOC);
