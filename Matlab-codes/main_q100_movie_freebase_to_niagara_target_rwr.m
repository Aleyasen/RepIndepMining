...
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/fullgraph/top2000_niagara_target';
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/top2000_q100_movie_freebase_to_niagara_target_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/cast.txt'], [DAT_LOC '/director.txt'], [DAT_LOC '/directedby.txt']  };
edge_files = { [DAT_LOC '/actor_cast.txt'], [DAT_LOC '/movie_cast.txt'], [DAT_LOC '/directedby_director.txt'], [DAT_LOC '/directedby_movie.txt']};
