...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/new_top2000_q100_movie_imdb_to_niagra_2_source_without_cast_result';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/movie.txt'], [DAT_LOC '/actor.txt'], [DAT_LOC '/character.txt'], [DAT_LOC '/director.txt']};
edge_files = { [DAT_LOC '/actor_character.txt'], [DAT_LOC '/movie_character.txt'], [DAT_LOC '/movie_actor.txt'], [DAT_LOC '/movie_director.txt']};
