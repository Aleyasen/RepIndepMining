...
%DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/courses-uw';
DAT_LOC = '/srv/data/projects/apps/RepIndep_CIDR/output-uw3';

ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_target_remove_multi_subj_schema_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/course.txt'], [DAT_LOC '/offer.txt'], [DAT_LOC '/inst.txt'], [DAT_LOC '/subject.txt']  };
edge_files = { [DAT_LOC '/offer_inst.txt'], [DAT_LOC '/course_offer.txt'], [DAT_LOC '/course_subject.txt']};
query_file = [DAT_LOC '/_query.txt'];
answer_loc = ANS_LOC;
label = 'course';
%alg = 'pathsim'; metapath = {'course','subject'};
%alg = 'rwr';
alg = 'simrank';
VERBOSE = 0;
