...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_target_path3_results';
mkdir(ANS_LOC);
...
answer_loc = ANS_LOC;
label = 'course';
alg = 'pathsim'; metapath = {'course','inst', 'course', 'subject'};
%alg = 'rwr';
%alg = 'simrank';
VERBOSE = 0;
