...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/simtest-dblp/sigmod-c50-top2000';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/title.txt'], [DAT_LOC '/author.txt'], [DAT_LOC '/year.txt'], [DAT_LOC '/conf.txt'], [DAT_LOC '/authorsgrp.txt'] };
edge_files = { [DAT_LOC '/title_authorsgrp.txt'], [DAT_LOC '/authorsgrp_author.txt'], [DAT_LOC '/title_conf.txt'], [DAT_LOC '/title_year.txt'] };
query_file = [DAT_LOC '/_query.txt'];
answer_loc = ANS_LOC;
label = 'author';
%alg = 'pathsim'; metapath = {'author','authorsgrp','title','conf'};
%alg = 'rwr';
%alg = 'simrank';
alg = '?';
VERBOSE = 0;
