...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/uw-courses_target_wsu_schema_wo_inst_results';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/course.txt'], [DAT_LOC '/offer.txt'], [DAT_LOC '/subject.txt']  };
edge_files = { [DAT_LOC '/course_offer.txt'], [DAT_LOC '/course_subject.txt']};
