...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/dblp-target-c100-new-schema-area-mp-modpath2';
mkdir(ANS_LOC);
...
label = 'proc';
alg = 'modpathsim1'; metapath = {'proc','area'}; star = [0 0]; % star = 1 when label at i is star
%alg = 'rwr';
%alg = 'simrank';
%alg = '?';
VERBOSE = 0;
