...
ANS_LOC = '/srv/data/projects/apps/RepIndep_CIDR/MATLAB/aale/simtest-freebase/dblp-target-c50-proc-area-metapath';
mkdir(ANS_LOC);

%% inputs
node_files = { [DAT_LOC '/title.txt'], [DAT_LOC '/author.txt'], [DAT_LOC '/area.txt'], [DAT_LOC '/proc.txt'] };
edge_files = { [DAT_LOC '/title_author.txt'], [DAT_LOC '/title_proc.txt'], [DAT_LOC '/proc_area.txt'] };
...
%% algorithms
alg = 'pathsim'; metapath = {'proc','area'};
